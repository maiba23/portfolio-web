  ...
  const openPopupboxNetflix = () => {
    const content = (
      <>
        ...
        <b>Website:</b>{" "}
        <a className="hyper-link" href="https://catssoft.pl/">
          https://catssoft.pl/
        </a>
        <br />
        <b>GitHub:</b>{" "}
        <a
          ...
          href="https://github.com/lkot/catssoft-webpage"
        >
  ...
  const openPopupboxCityGuide = () => {
    const content = (
      <>
        ...
        <b>Website:</b>{" "}
        <a className="hyper-link" href="https://lukaszkot.biz/">
          https://lukaszkot.biz/
        </a>
        <br />
        <b>GitHub:</b>{" "}
  ...
  const openPopupboxPortfolio = () => {
    const content = (
      <>
        ...
        <b>Video:</b>{" "}
        <a className="hyper-link" href="https://vimeo.com/555818973">
